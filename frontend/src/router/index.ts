...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/post/:id', name: 'post', component: () => import('../components/Placeholder.vue'), props: { title: '帖子详情' }, meta: { title: '帖子详情' } },
    { path: '/publish', name: 'publish', component: () => import('../components/Placeholder.vue'), props: { title: '发布帖子' }, meta: { title: '发布', requiresAuth: true } },
