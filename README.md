...
- `frontend/` — Web 前端代码（Vue 3 + Vite + Element Plus + **Tailwind v4 工具层 / 令牌层**；登录 / 注册 / 个人主页 + 版块列表 / 发帖 / 帖子详情共 6 页可用）
