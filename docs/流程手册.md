...
> **变更记录**
>
> - **v1.1（2026-09-11）**——4.5 节补充治理类记录（评审门纪要 / 裁剪与让步放行记录 / 变更台账）的归档位置与命名约定，并新增"版本号单一登记处"约定。**未改动 7 阶段 6 门的流程实质与任何出口标准**。修订动因：4.1 节要求"评审结论与行动项记录归档至 `docs/`"，但原文未规定落点，导致三道门纪要实际从未归档（见 [设计门纪要](reviews/gate-3-design.md) 第 2 节）。
> - v1.0（2026-08-30）——初版。
...
**交付物**：[BRD（模板）](templates/brd-template.md) · [可行性分析报告（模板）](templates/feasibility-template.md) · [项目章程（模板）](templates/charter-template.md)
...
> 本项目实际交付物：[initiation/brd.md](initiation/brd.md) · [initiation/feasibility-study.md](initiation/feasibility-study.md) · [initiation/project-charter.md](initiation/project-charter.md)
...
**交付物**：[PRD（模板）](templates/prd-template.md)、原型图、需求跟踪矩阵（RTM）
...
**交付物**：[技术方案（模板）](templates/tech-design-template.md)、API 文档、UI 稿
...
1. 编写[测试计划（模板）](templates/test-plan-template.md)，用例设计（等价类、边界值、场景法）；
...
1. 发布评审：逐项确认[上线检查清单（模板）](templates/release-checklist-template.md)（配置、数据迁移、灰度方案、回滚预案）；
...
4. 新需求与缺陷回流到阶段二（需求）；
5. 阶段性收尾：项目复盘（[模板](templates/retrospective-template.md)）、文档归档。
...
| 记录类型 | 归档位置 | 命名 |
|---------|---------|------|
| 评审门纪要（含出口标准逐项核对、结论、行动项、批准记录） | `docs/reviews/` | `gate-<阶段号>-<阶段英文名>.md`，如 `gate-3-design.md` |
| 流程裁剪与让步放行记录 | `docs/tailoring-waivers.md` | 单文件累积登记，条目编号 `W-<序号>`（让步放行）/ `T-<序号>`（已授权裁剪） |
| 变更台账（基线变更申请与影响评估） | `docs/change-log.md` | 单文件累积登记，条目编号 `CR-<序号>` |

补充约定：

- **版本号单一登记处**：文档版本号只在 [docs/README.md](README.md) 索引表登记。其他文档交叉引用时**只写链接、不写版本号**（如"见[技术方案](design/tech-design.md)"，而非"见技术方案 v0.2"），避免版本升级后引用大面积失效；
...
| 阶段 | 模板 |
|------|------|
| 立项启动 | [BRD](templates/brd-template.md) · [可行性分析](templates/feasibility-template.md) · [项目章程](templates/charter-template.md) |
| 需求 | [PRD](templates/prd-template.md) |
| 设计 | [技术方案](templates/tech-design-template.md) |
| 测试 | [测试计划](templates/test-plan-template.md) |
| 发布 | [发布检查清单](templates/release-checklist-template.md) |
| 收尾 | [项目复盘](templates/retrospective-template.md) |
